            ...
            <form action="{{route('grados.update', ['grado' => $grado->id])}}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" 
                        value="{{old('nombre') ?: $grado->nombre}}" placeholder="Escriba el nombre del grado...">
                </div>
                <div class="mb-3">
                    <label for="profesor_id">Profesor</label>
                    <select class="form-select" data-profesor-id="{{old('profesor_id') ?: $grado->profesor_id}}" id="profesor_id" name="profesor_id" aria-label="Profesor">
