...
@section('content')
    <div class="row">
        <div class="col-9 offset-1">
            <h3>Clases del alumno {{$alumno->nombreCompleto()}}</h3>
            <a class="btn btn-outline-success btn-lg" href="{{route('alumnos.agregar_clase', ['alumno' => $alumno->id])}}">Agregar clase</a>
        </div>
    </div>
    <br>
    <div class="row">
        <div class="col-10 offset-1">
            <table class="table table-striped table-dark">
                ...
                <tbody>
                    @foreach($alumno->alumnos_grados as $alumno_grado)
